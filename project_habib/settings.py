"""
Django settings for project_habib project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-mm+g=5t5sfgpn*$g$=14z7z(-5l)%)@v!7&uulz(v)_rr9^^ko')
...
ROOT_URLCONF = 'project_habib.urls'
...
WSGI_APPLICATION = 'project_habib.wsgi.application'
